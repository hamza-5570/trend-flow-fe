    ...
    <div className="min-w-[1000px] flex items-center justify-between px-5 py-3 border-b border-[#DBE0E5]">
        <div className="w-[20px]">
         <label className="custom-checkbox">
                  <input
                    type="checkbox"
                     onChange={handleSelectAllTopSelling}
                  />
                  <span className="checkmark"></span>
                </label>
      </div>
      <div className="w-[152px] text-sm text-[#121417] font-medium">SKU</div>

      <div className="w-[145px] text-sm text-[#121417] font-medium">Name</div>
