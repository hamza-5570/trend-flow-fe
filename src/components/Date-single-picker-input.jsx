...
const DatePickerPopover = ({ initialDate = null, name = "publishDate" }) => {
  ...
  return (
    <Field name={name}>
      {({ field }) => (
        <Popover>
          <PopoverTrigger className="w-full text-sm border border-[#C8C8C8] rounded-md focus:outline-none placeholder:text-[#414141] text-[#121417]  px-4 py-3 cursor-pointer">
            {date ? (
