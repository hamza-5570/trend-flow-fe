        ...
        <div className="xl:w-[525px] mx-auto px-5 xl:px-0 pb-5">
          ...
          <div className="pt-5 md:pt-16">
            <p className="text-lg/relaxed md:text-2xl/relaxed font-medium text-white">
              AI-Powered Forecasting to Prevent Stockouts & Overstock.
            </p>

            <p className="text-sm/relaxed md:text-base/relaxed text-white pt-3 md:pt-6">
              Every inventory mistake costs you. Stockouts mean lost sales.
            ...
            <p className="text-sm/relaxed md:text-base/relaxed text-white pt-5 md:pt-14">
              TrendFlow keeps your inventory balanced—no more, no less.
            </p>

            <div className="pt-5">
              <p className="text-sm md:text-base text-white">
                ✅ Maximize revenue by keeping best-sellers in stock.
              </p>

              <p className="text-sm md:text-base text-white pt-1">
                ✅ Reduce waste & storage costs by avoiding excess inventory.
              </p>
              <p className="text-sm md:text-base text-white pt-1">
                ✅ Stay ahead of demand with AI-driven sales forecasts.
              </p>
              <p className="text-sm md:text-base text-white pt-1">
                ✅ Enterprise-level forecasting—at a fraction of the cost.
              </p>
            </div>

            <p className="text-xl md:text-[27px] text-white pt-10 md:pt-16">
              First month 50% off. 7-day full refund. Start optimizing your
              inventory today!
            </p>
          </div>
        </div>
